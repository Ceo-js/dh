...
document.querySelector( "ceo" ).append( document.createElement( "input" ) );
document.querySelector( "ceo" ).querySelector( "input" ).setAttribute( "type", "text" );
document.querySelector( "ceo" ).querySelector( "input" ).setAttribute( "placeholder", "Qual é o nome do arquivo? " );
document.querySelector( "ceo" ).querySelector( "input" ).style.zIndex = "999";
document.querySelector( "ceo" ).querySelector( "input" ).style.width = "15vw";
document.querySelector( "ceo" ).querySelector( "input" ).style.height = "3vh";
document.querySelector( "ceo" ).querySelector( "input" ).style.padding = "2vw";
document.querySelector( "ceo" ).querySelector( "input" ).style.color = "rgb(238, 238, 238)";
document.querySelector( "ceo" ).querySelector( "input" ).style.position = "fixed";
document.querySelector( "ceo" ).querySelector( "input" ).style.top = "69px";
document.querySelector( "ceo" ).querySelector( "input" ).style.left = "48%";
document.querySelector( "ceo" ).querySelector( "input" ).style.right = "50%";
document.querySelector( "ceo" ).querySelector( "input" ).style.borderRadius = "7px";
document.querySelector( "ceo" ).querySelector( "input" ).style.display = "grid";
document.querySelector( "ceo" ).querySelector( "input" ).style.placeItems = "center";
document.querySelector( "ceo" ).querySelector( "input" ).style.margin = "0px auto";
