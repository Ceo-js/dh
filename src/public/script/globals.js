...
import ap from "includes/appbar.js";
let pageFooter = document.createElement( "page-footer" ),
	footerTemplate = `
<footer-overlay>
...
/* [ properties ]
    ...
    let appbarImport = document.createElement( "script" );
    appbarImport.src = "includes/appbar.js";
    document.body.appendChild( appbarImport );
